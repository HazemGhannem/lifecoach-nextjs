      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        <div className="text-center">
          <h1 className="text-5xl md:text-6xl font-bold mb-6">
            Il est temps de passer de 'rêver' à 'devenir'
          </h1>
          <p className="text-xl md:text-2xl mb-8 opacity-90 max-w-4xl mx-auto">
            Vous sentez-vous à la croisée des chemins, avec le sentiment que
            votre véritable potentiel est inexploité ? Investissez en vous-même
            dès aujourd'hui et commencez à vivre la vie que vous avez toujours
            imaginée.
          </p>
          <Link
            href="/booking"
